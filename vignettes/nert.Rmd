...
=======
  ...
  %\VignetteDepends{terra}
  %\VignetteDepends{usethis}
>>>>>>> 8e754f6 (Updated nert analytics vignette and fixed some typos in the nert.Rmd one too)
...
#> Error: lazy-load database '/Users/283204f/Library/R/arm64/4.4/library/nert/R/nert.rdb' is corrupt

extract(r, xy = TRUE, data.frame(lon = 138.6007, lat = -34.9285))
#> Error: unable to find an inherited method for function 'extract' for signature 'x = "nert", y = "data.frame"'
```
...
=======
# add the key to your OS's credential store
>>>>>>> d314d51 (add comments about get_key and set_key for clarity and reknit)
key_set("NERT_API_KEY", keyring = "nert")
...
``` r
autoplot(r)
#> Error: unable to find an inherited method for function 'has.RGB' for signature 'x = "nert"'
```
