test_that("A valid URL is created for the ETa collection", {
  ...
  expect_match(url, "model-derived/aet/v2_2/2023/2023_01_01/", fixed = TRUE)
  expect_match(url, "CMRSET_LANDSAT_V2_2_2023_01_01_ETa\\.vrt$", perl = TRUE)
})
...
test_that("A valid URL is created for the pixel_qa collection", {
  ...
  expect_match(
    url,
    "CMRSET_LANDSAT_V2_2_2023_06_01_pixel_qa\\.vrt$",
    perl = TRUE
  )
})
