...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("AAGI-AUS/nert", fork = TRUE)`.
...
Please note that the {nert} project is released with a [Contributor Code
of Conduct](https://aagi-aus.github.io/nert/CODE_OF_CONDUCT.md). By
