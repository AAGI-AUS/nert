...
The {nert} package also provides a convenient function `collect_tern_data()` which allows you to easily grab multiple TERN datasets across multiple times and multiple spatial locations. For example, the below code grabs the SMIPS "totalbucket" and SLGA "CLY" clay content estimates at 0-5cm across the first week of 2024 at Merriden, WA and Tamworth, NSW:
