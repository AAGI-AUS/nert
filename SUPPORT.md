...
Thank you for your interest in `nert`. There are several places to get
help.

## Questions about how to use the package

- Open a [GitHub
  Discussion](https://github.com/AAGI-AUS/nert/discussions) if the
  question is broad (“how would I use
...
- Open an Issue with:
  - the [`sessionInfo()`](https://rdrr.io/r/utils/sessionInfo.html)
    output,
