...
- New vignette, *Bandwidth-safe spatial subsetting*, showing how to crop to an
  area of interest, extract at point locations, and save a local copy so that
  only the data you need crosses the network, and covering the coordinate
  reference system handling for the canopy height dataset.
